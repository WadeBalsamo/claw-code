...
# Installs claw-code dependencies, installs/configures Ollama, pulls nemotron-3-nano:4b,
...
# --- Pull model ---
echo "==> Pulling nemotron-3-nano:4b from Ollama"
...
echo "  clawcode --provider ollama --model nemotron-3-nano:4b"
